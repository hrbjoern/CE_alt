...
em = 0.9      # efficiency expectation
sde = 0.3*0.9 # efficiency standard deviation
...
if len(sys.argv)!=7:
    ...
    print "python LimitsRolkePoisson7.py Non Noff ConfLevel alpha em sde"
    print
...
# Select model no. 7:
# SCREW THIS. Model no. 4.1.7 in the paper is model "2" in the tutorial.
# ------------
